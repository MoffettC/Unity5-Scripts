...
public class MS04 : MonoBehaviour {
    ...
    void InitialSpawning() {
        foreach (GameObject child in spawnPoints) {
            ...
            eSpawn.maxNumbAttackers = 40;
            eSpawn.secBeforeSpawn = 10;
            eSpawn.yieldTimeMax = 10;
            eSpawn.yieldTimeMin = 5;
